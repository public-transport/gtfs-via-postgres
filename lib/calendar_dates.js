...
`)
	...
	await db[RUN](`\
CREATE INDEX "${opt.schema}.calendar_dates_service_id" ON "${opt.schema}.calendar_dates" (service_id);
CREATE INDEX "${opt.schema}.calendar_dates_exception_type" ON "${opt.schema}.calendar_dates" (exception_type);
`)
